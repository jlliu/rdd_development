...
var tutorialScene = function (p) {
  ...
  p.setup = function () {
    ...
    tutorialCanvas = p.createCanvas(canvasWidth, canvasHeight).elt;
    tutorialCanvas.classList.add("gameCanvas");
    tutorialCanvas.classList.add("tutorialCanvas");
    tutorialCanvas.id = "tutorial";
    ...
    setupNavigation(tutorialCanvas);
  };
...
new p5(tutorialScene, "tutorial-canvas-container");
